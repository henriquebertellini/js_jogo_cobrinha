...
//Criae cobrinha como vetor, já que ela vai ser uma série de coordernadas, que quando pintadas, criam os quadradinhos
let snake = [];
...
//Quando um evento acontece, detecta e chame a função
